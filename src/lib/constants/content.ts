...
export const FEATURE_PAGE_CONTENT: IFEATURE_PAGE[] = [
	...
	},
	{
		...
		description: `Мы предлагаем вам следующие виды помощи: 
			...
			\n - Способы релаксации. Мы посоветуем
			вам, как снять стресс и негативные эмоции, используя различные методы
			релаксации, такие как дыхательные упражнения, медитация, йога, музыка,
			хобби и т.д. 
